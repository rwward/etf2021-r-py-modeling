...
Many modeling techniques in R require different syntax and different data structures. Tidymodels provides a modeling workflow that standardizes syntax and data structures regardless of the model type. 
...
- {[parsnip](https://parsnip.tidymodels.org/)}: Provides a tidy, unified interface to models than can by used to try a range of models without getting bogged down in the syntactical minutae of the underlying packages.
