...
We can extract the coefficients from the `logisticregressioncv` step of our pipeline.
...
# import numpy as np
# coef_summary['exp_coefs'] = np.exp(coef_summary['coefs'])
...
fig, ax = sklearn.metrics.ConfusionMatrixDisplay.from_predictions(y_test, y_pred)
